...
//			if (sonuc.indexOf("button") != -1 && sonuc.indexOf("popover") != -1) {
				//alert("html-pre \n a: " + a + "\n sonuc: " + sonuc );
//				$('body').append('<code><pre><div>' + a + '       <br><br>        ' + sonuc + '</div></pre></code>');
//				$('body').append('<hr><textarea style="background-color: #cceaff">' + a + '<br><br>' + sonuc + '</textarea><hr>');
//				$('body').append('<hr><textarea style="background-color: #cceaff">' + a + '</textarea>');
//				$('body').append('<textarea style="background-color: #cceaff">' + sonuc + '</textarea><hr>');
//			} else {
//				$('body').append('<textarea>' + a + '      <br><br>        ' + sonuc + '</textarea>');
//			}
...
//			return $.text(a);
		...
		{
//			if (x.indexOf("elina") != -1 || y.indexOf("ehta") != -1
//			 || y.indexOf("elicit") != -1  || y.indexOf("atlak") != -1
//			  || y.indexOf("ihan") != -1  || y.indexOf("atun") != -1) {
//				alert("html-asc \n\n\n x: " + x + "\n\n\n y: " + y + "\n\n\n sonuc: " + (x > y));
//			}
			return ((x < y) ? -1 : ((x > y) ? 1 : 0));
		},
